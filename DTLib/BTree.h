...
namespace DTLib
{
    ...
    public:
        ...
        virtual BTreeNode<T>* insert(BTreeNode<T>* node, BTNodePos pos)
        {
            ...
            {
                THROW_EXCEPTION(InvalidOperationException,"Parent node cannot be NULL...");
            }
        ...
        virtual BTreeNode<T>* insert(const T& value, TreeNode<T>* parent,BTNodePos pos)
        {
            BTreeNode<T>* ret = NULL;
        ...
        SharedPointer<Tree<T>> remove(const T& value)
        {
            ...
            if (node == NULL)
            {
                THROW_EXCEPTION(InvalidOperationException, "Can not find the tree node via value ...");
            }
            else
            {
                remove(node,ret);
